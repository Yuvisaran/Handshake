...
class AddPropertyStep2 extends Component {
  constructor(props) {
    super(props);
  ...
  handleProperty = (e) => {
    ...
    console.log("seller tpe ", seller_type)
  ...
  handleChange1 = (e) => {
    let { name, value, checked } = e.target;
    this.setState({ escrow_companyCheck: checked });
    if (!this.state.escrow_companyCheck) {
      this.setState({ escrow_company: {} });
    }
  ...
  handleChange = (e) => {
    let { name, value, checked } = e.target;
    this.setState({ escrow_companyChecked: checked });
    if (!this.state.escrow_companyChecked) {
  ...
  submitValidations(event) {
    ...
    if (event.group_person3 && this.state.addPerson == true) {
      if (validator.isEmpty(event.group_person3.first_name)) {
        errors.group_person3.first_name = 'Please enter firstName';
      ...
      if (validator.isEmpty(event.group_person3.last_name)) {
        errors.group_person3.last_name = 'Please enter lastName';
    ...
    if (event.group_details && seller_type.party_type == 'group') {
      if (validator.isEmpty(event.group_details.first_name)) {
        errors.group_details.first_name = 'Please enter firstName';
      ...
      if (validator.isEmpty(event.group_details.last_name)) {
        errors.group_details.last_name = 'Please enter lastName';
    ...
    if (event.married_couple && seller_type.party_type == 'married') {
      if (validator.isEmpty(event.married_couple.first_name)) {
        errors.married_couple.first_name = 'Please enter firstName';
      ...
      if (validator.isEmpty(event.married_couple.last_name)) {
        errors.married_couple.last_name = 'Please enter lastName';
      ...
      if (!(validator.isEmail(event.married_couple.email))) {
        errors.married_couple.email = 'Please Enter valid Email ';
    ...
    if (event.corportion_details && seller_type.party_type == 'corporation') {
      if (validator.isEmpty(event.corportion_details.first_name)) {
        errors.corportion_details.legalEntityName = 'Please enter legal Entity Name';
      ...
      if (validator.isEmpty(event.corportion_details.middle_name)) {
        errors.corportion_details.authorisedsignerName = 'Please enter authorised signerName';
      ...
      if (validator.isEmpty(event.corportion_details.last_name)) {
        errors.corportion_details.authorisedsignerdesignation = 'Please enter authorised signature destination';
      ...
      if (!validator.isNumeric(event.corportion_details.phone_number)) {
        errors.corportion_details.phone_number = 'Please enter phone number';
      ...
      if (!(validator.isEmail(event.corportion_details.email))) {
        errors.corportion_details.email = 'Please enter valid email';
    ...
    if (!mailing_addressChecked) {
      ...
      if (!validator.isAlpha(event.mailing_address.city)) {
        errors.mailing_address.city = 'Please enter  city';
      ...
      if (event.mailing_address.state == '') {
        errors.mailing_address.state = 'Please select state';
      ...
      if (validator.isEmpty(event.mailing_address.zipcode)) {
        errors.mailing_address.zipcode = 'Please enter Zipcode';
        mailing_address.zipcode = '';
      } else if (!(validator.isNumeric(event.mailing_address.zipcode) && event.mailing_address.zipcode.length == 5)) {
        errors.mailing_address.zipcode = "zipcode must be 5 digit";
        mailing_address.zipcode = '';
      }
      else {
    ...
    if (event.title_company && !this.state.title_companyChecked) {
      ...
      if (!validator.isAlpha(event.title_company.city)) {
        errors.title_company.city = 'Please enter city';
        title_company.city = ''
      }
      ...
      if (event.title_company.state == '') {
        errors.title_company.state = 'Please select state';
      }
      else {
        delete errors.title_company.state;
      }
      //zipcode validation
      if (validator.isEmpty(event.title_company.zipcode)) {
        errors.title_company.zipcode = 'Please enter Zipcode';
        title_company.zipcode = '';
      } else if (!(validator.isNumeric(event.title_company.zipcode) && event.title_company.zipcode.length == 5)) {
        errors.title_company.zipcode = "zipcode must be 5 digit";
        title_company.zipcode = '';
      }
      else {
      ...
      if (!validator.isNumeric(event.title_company.phone_number)) {
        errors.title_company.phone_number = 'Please enter phone number';
      ...
      if (validator.isEmpty(event.title_company.company_name)) {
        errors.title_company.company_name = 'Please enter company name';
      ...
      if (!validator.isEmail(event.title_company.email)) {
        errors.title_company.email = 'Please enter valid email';
        title_company.email = '';
      }
      else {
    ...
    if (!this.state.escrow_companyCheck || this.state.escrow_companyChecked) {
      ...
      if (validator.isEmpty(event.escrow_company.street_address)) {
        errors.escrow_company.street_address = 'Please enter address';
      }
      else {
      ...
      if (!validator.isAlpha(event.escrow_company.city)) {
        errors.escrow_company.city = 'Please enter city';
        escrow_company.city = ''
      }
      ...
      if (event.escrow_company.state == '') {
        errors.escrow_company.state = 'Please select state';
      }
      else {
      ...
      //   escrow_company.zipcode = '';
      // }
      if (validator.isEmpty(event.escrow_company.zipcode)) {
        errors.escrow_company.zipcode = 'Please enter  Zipcode';
        escrow_company.zipcode = '';
      } else if (!(validator.isNumeric(event.escrow_company.zipcode) && event.escrow_company.zipcode.length == 5)) {
        errors.escrow_company.zipcode = "zipcode must be 5 digit";
        escrow_company.zipcode = '';
      } else {
      ...
      if (!validator.isNumeric(event.escrow_company.phone_number)) {
        errors.escrow_company.phone_number = 'Please enter phone number';
      ...
      if (validator.isEmpty(event.escrow_company.company_name)) {
        errors.escrow_company.company_name = 'Please enter company name';
      ...
      if (!validator.isEmail(event.escrow_company.email)) {
        errors.escrow_company.email = 'Please enter valid email';
    ...
    //   notify.show("Please Enter all mandatory Fields", "custom", 5000, myColor);
    // }
    return errors;
  }
  ...
  secondStepCompleted = () => {
    ...
    let self = this;
    console.log("seller details", this.state.seller_type.party_type)
    ...
    if (married_err && corportion_err && escrow_err && group_err && person3_err && mailing_err && title_err) {
      ...
      if (this.state.single || this.state.married || this.state.corporation || this.state.group) {
        ...
        console.log("form details of seller type ", form_totaldetails.seller_type);
        if (this.isEmpty(escrow_company)) {
          delete form_totaldetails.escrow_company
        }
        console.log("form_totaldetails", form_totaldetails)
        ...
        postData.then(data => {
          ...
          if (responseData != undefined) {
            ...
            (responseData.message ? notify.show(responseData.message[0], "custom", 5000, myColor) : '')
          }
                ...
                <div className="individual_adress">
                  ...
                  <div className="individual_adress">
                    ...
                    <label className="custom_checkbox margBT0">
                      ...
                      <input type="checkbox" name="title_companyChecked" checked={this.state.title_companyChecked} onChange={e => this.handletitleCompany(e)} />
                      <span className="checkmark" />
                    </label>
                  ...
                  <div className="individual_adress">
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <label className="custom_checkbox margBT0">
                        ...
                        <input type="checkbox" name="escrow_companyCheck" checked={this.state.escrow_companyCheck} disabled={this.state.escrow_companyChecked} onChange={e => this.handleChange1(e)} />
                        <span className="checkmark" />
                      </label>
                    </div>
